...
export default function SocialProof() {
  return (
    <section className="py-24 bg-gradient-to-r from-orange-50 via-pink-50 to-purple-50">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <div 
              key={index}
              className="bg-white/80 backdrop-blur-sm p-8 rounded-3xl shadow-xl hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300 border border-white/20"
            >
              ...
              <div className="mt-4 bg-gradient-to-r from-orange-100 to-pink-100 px-4 py-2 rounded-full text-sm font-medium text-orange-700">
